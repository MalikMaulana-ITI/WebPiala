<div class="bg-white rounded-2xl shadow-custom border border-gray-100 overflow-hidden p-6 sm:p-8 lg:p-12">
    ...
    <div class="bg-green-50 border border-green-200 rounded-lg p-6 space-y-4 shadow-sm">
        ...
        <hr class="border-gray-200 my-4">
        <h5 class="text-lg font-semibold text-gray-800 mb-3">Detail Trofi</h5>
        ...
        <div class="space-y-3 grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <p class="font-normal">Kustom (Desain Sendiri)</p>
            </div>
            <div>
        ...
        <div class="space-y-3 grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
                <p class="text-sm font-semibold">Nama Trofi:</p>
                <p class="text-md">{{ $invoice->order->trophy->name }}</p>
            </div>

            <div>
                <p class="text-sm font-semibold">Harga Dasar Trofi:</p>
            ...
            <div>
                <p class="text-sm font-semibold">Gambar Trofi:</p>
            ...
            {{-- Tambahkan detail trofi standar lainnya --}}
            <div>
        ...
        @else
        <p class="text-sm text-gray-600 mt-4">Detail trofi tidak tersedia untuk pesanan ini.</p>
        @endif
        @else
